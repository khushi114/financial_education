...
import { Play, Trophy, Target, BookOpen, Coins, Star, ArrowRight, Sparkles, TrendingUp, Brain } from 'lucide-react';
...
const LandingPage = () => {
  ...
  const handleExploreChallenges = () => {
    if (user) {
      ...
      toast.error('Please log in to explore challenges!');
      navigate('/login');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 relative overflow-hidden">
      ...
      <nav className="relative z-10 p-6 flex justify-between items-center">
        ...
        {user ? (
          <button
            ...
            className="bg-gradient-to-r from-purple-400 to-pink-400 text-white px-8 py-3 rounded-full font-semibold hover:from-purple-500 hover:to-pink-500 transition-all transform hover:scale-105 shadow-lg"
          >
            Register
          </button>
        ) : (
        ...
        <div className={`max-w-6xl mx-auto transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-10 py-5 rounded-full font-bold text-xl hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-xl flex items-center space-x-3"
            >
            ...
            <button
              ...
              className="bg-white text-purple-600 px-10 py-5 rounded-full font-bold text-xl hover:bg-gray-50 transition-all transform hover:scale-105 shadow-xl flex items-center space-x-3 border-2 border-purple-200"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {games.map((game, index) => (
              <div
                ...
                onClick={() => user ? navigate('/Register') : navigate('/login')}
              >
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-400 to-pink-400 rounded-3xl p-16 text-white shadow-2xl">
            ...
            <button
              ...
              className="bg-white text-purple-600 px-12 py-5 rounded-full font-bold text-xl hover:bg-gray-50 transition-all transform hover:scale-105 shadow-2xl"
            >
              {user ? 'Go to Register' : 'Start Your Journey'}
            </button>
          </div>
        </div>
      </section>
      ...
      <footer className="relative z-10 px-6 py-12 text-center text-gray-600">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg">© 2025 Level Up. Empowering everyone through financial education.</p>
        </div>
      </footer>
